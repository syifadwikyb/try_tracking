...
function animateBus() {
    // Balik arah jika sudah sampai di ujung rute
    if (currentIndex + direction >= routeCoordinates.length || currentIndex + direction < 0) {
        direction *= -1;
    }
    ...
    // Atur interval pergerakan setiap 1000ms (1 detik)
